...
class Interpreter:
    ...
    def visit_CallNode(self, node, context):
        ...
        if res.error: return res
        value_to_call = value_to_call.copy().set_pos(node.pos_start, node.pos_end)  # Add this
        ...
        if res.error: return res
        return_value = return_value.copy().set_pos(node.pos_start, node.pos_end).set_context(context)  # Add this
        return res.success(return_value)
