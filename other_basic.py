...
class Parser:
  ...
  def statement(self):
    ...
    if res.error:
      return res.failure(InvalidSyntaxError(
        self.current_tok.pos_start, self.current_tok.pos_end,
        "Expected 'release - return', 'continue', 'shatter - break', 'initiate', 'if', 'for', 'endure', 'function', int, float, identifier, '+', '-', '(', '[' or 'not'"
      ))
  ...
  def expr(self):
    ...
    if res.error:
      return res.failure(InvalidSyntaxError(
        self.current_tok.pos_start, self.current_tok.pos_end,
        "Expected 'initiate', 'if', 'for', 'endure', 'function', int, float, identifier, '+', '-', '(', '[' or 'not'"
      ))
  ...
  def comp_expr(self):
    ...
    if res.error:
      return res.failure(InvalidSyntaxError(
        self.current_tok.pos_start, self.current_tok.pos_end,
        "Expected int, float, identifier, '+', '-', '(', '[', 'if', 'for', 'endure', 'function' or 'not'"
      ))
  ...
  def atom(self):
    ...
    return res.failure(InvalidSyntaxError(
      ...
      "Expected int, float, identifier, '+', '-', '(', '[', if', 'for', 'endure', 'function'"
    ))
  ...
  def func_def(self):
    ...
    if self.current_tok.type == TT_ARROW:
        ...
        # Parse the expression after the arrow
...
class BuiltInFunction(BaseFunction):
  ...
  # LIST IN-BUILT FUNCTIONS / LIST METHODS ============================================================
  def execute_push(self, exec_ctx): # Previously execute_append
  ...
  def execute_merge(self, exec_ctx):
    ...
    merged = List(listA.elements + listB.elements)  # Create a NEW list
    return res.success(merged)  # Return the merged list
  ...
  def execute_contains(self, exec_ctx):
    ...
    found = any(
        (isinstance(element, Number) and isinstance(value, Number) and element.value == value.value) or
        (isinstance(element, String) and isinstance(value, String) and element.value == value.value)
        for element in list_.elements
    )
    return res.success(Number.true if found else Number.false)
  ...
  def execute_count(self, exec_ctx):
    ...
    a = isinstance(element, Number) and isinstance(value, Number)
    b = isinstance(element, String) and isinstance(value, String)

    for element in list_.elements:
      if a and element.value == value.value:
        count += 1
      elif b and element.value == value.value:
        count += 1
      
    return res.success(Number(count))
  execute_count.arg_names = ["list", "value"]
  ...
  def execute_sort(self, exec_ctx):
      ...
      try:
          sorted_elements = sorted(
              list_.elements,
              key=lambda x: x.value if isinstance(x, (Number, String)) else 0
          )
          return res.success(List(sorted_elements))
      except TypeError:
          return res.failure(RTError(
              self.pos_start, self.pos_end,
              "List contains uncomparable types",
              exec_ctx
          ))
  ...
  def execute_average(self, exec_ctx):
      ...
      return res.success(Number(total / len(list_.elements)))
  ...
  def execute_min(self, exec_ctx):
      ...
      min_val = min(x.value for x in list_.elements)
      return res.success(Number(min_val))
  ...
  def execute_max(self, exec_ctx):
      ...
      max_val = max(x.value for x in list_.elements)
      return res.success(Number(max_val))
...
# MATH IN-BUILT FUNCTION ============================================================
  ...
  def execute_abs(self, exec_ctx):
      ...
      return res.success(Number(abs(x.value)))
  ...
  def execute_round(self, exec_ctx):
      ...
      return res.success(Number(round(x.value)))
  ...
  def execute_ceil(self, exec_ctx):
      ...
      return res.success(Number(math.ceil(x.value)))
  ...
  def execute_floor(self, exec_ctx):
      ...
      return res.success(Number(math.floor(x.value)))
  ...
  def execute_sqrt(self, exec_ctx):
      ...
      return res.success(Number(math.sqrt(x.value)))
  ...
  def execute_power(self, exec_ctx):
      ...
      return res.success(Number(x.value ** y.value))
...
# GENERIC IN-BUILTS FUNCTION ============================================================
  ...
  def execute_type_of(self, exec_ctx):
    ...
    if value == Number.null:
        ...
        type_name = "function"
    elif value == Number.true or value == Number.false:
        type_name = "boolean"
    else:
        type_name = "unknown"
    
    return res.success(String(type_name))
  ...
  def execute_str(self, exec_ctx):
      ...
      elif value == Number.true:
          return res.success(String("true"))
      elif value == Number.false:
          return res.success(String("false"))
      elif isinstance(value, Number):
          # Handle integer vs float representation
          if isinstance(value.value, int) or value.value.is_integer():
              return res.success(String(str(int(value.value))))
          else:
              return res.success(String(str(value.value)))
      elif isinstance(value, String):
          return res.success(value)  # Already a string
      elif isinstance(value, List):
          elements = []
          for element in value.elements:
              str_val = res.register(self.execute_str(Context("str"), element))
              if res.error: return res
              elements.append(str_val.value)
          return res.success(String(f"[{', '.join(elements)}]"))
      else:
          return res.success(String(str(value)))
  ...
  def execute_int(self, exec_ctx):
      ...
      elif value == Number.false or value == Number.null:
          return res.success(Number(0))
      else:
          return res.failure(RTError(
              self.pos_start, self.pos_end,
              f"Cannot convert {self.type_of(value).value} to integer",
              exec_ctx
          ))
  ...
  def execute_float(self, exec_ctx):
      ...
      if isinstance(value, Number):
          ...
          return res.success(Number(1.0))
      elif value == Number.false or value == Number.null:
          return res.success(Number(0.0))
      else:
          return res.failure(RTError(
              self.pos_start, self.pos_end,
              f"Cannot convert {self.type_of(value).value} to float",
              exec_ctx
          ))
...
global_symbol_table.set("bankai", BuiltInFunction.print)
global_symbol_table.set("bankai_ret", BuiltInFunction.print_ret)
